...
function loadConfig() {
  ...
  return {
    ...
    minTokens: parseIntValue(process.env.MIN_TOKENS, 64),
    tokensPerChar: parseFloatValue(process.env.TOKENS_PER_CHAR, 1.2),
    presencePenalty: parseFloatValue(process.env.PRESENCE_PENALTY, 0),
    frequencyPenalty: parseFloatValue(process.env.FREQUENCY_PENALTY, 0),
    ...
    freeDebateMaxRounds: parseIntValue(process.env.FREE_DEBATE_MAX_ROUNDS, 0),
    freeDebateTotalChars: parseIntValue(process.env.FREE_DEBATE_TOTAL_CHARS, 0),
    freeDebateMinChars: parseIntValue(process.env.FREE_DEBATE_MIN_CHARS, 120),
    ...
    repeatSimThreshold: parseFloatValue(process.env.REPEAT_SIM_THRESHOLD, 0.92),
    repeatPenalty: parseFloatValue(process.env.REPEAT_PENALTY, 0.35),
    repeatSameRoundPenalty: parseFloatValue(process.env.REPEAT_SAME_ROUND_PENALTY, 0.4),
    journalDir,
    stateDir,
